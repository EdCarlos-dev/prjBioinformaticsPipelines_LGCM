...
def process_one_sample(cram_file, bed_file, output_dir, intermediate_dir,
    ...
    try:
        ...
        coverage_file = os.path.join(sample_output_dir, "coverage_results.txt")
        with open(coverage_file, "w") as f:
            f.write(str(coverage_results))
        sample_logger.info(f"Cobertura calculada e salva em {coverage_file}")
    except Exception as e:
